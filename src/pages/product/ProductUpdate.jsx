...
const ProductUpdate = () => {
    ...
    const submitProduct = (e) => {
        ...
        axios({
            method: 'put',
            url: `http://localhost:8088/product/update/${id}`,
            headers: {
    ...
    return (
        <>
            ...
            <Form onSubmit={submitProduct} className={styles.productCreateBody}>
                ...
                {/* <Form.Group className={styles.productDealingStatus} controlId="formBasicDealingStatus">
                    <Form.Label>거래 상태</Form.Label>
                    <Form.Control
                        as="select"
                        value={product.dealingStatus}
                        onChange={changeValue}
                        name='dealingStatus'
                    >
                ...
                <Form.Group className={styles.submitButton}>
